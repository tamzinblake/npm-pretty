...
print.make('spaces' ,function (n) {
  for (var i = 0 ;i < n ;i++) {
    print(' ')
  }
})

print.make('indent' ,function (type) {
  switch(type) {
    case 'block': print.spaces(2) ;break
    case 'sep': print.spaces(2) ;break
    default: print('/* Unknown indentation!!! */')
  }
})
...
print.make('newline' ,function (type) {
  print.printedSomething = false
  print('\n')
  print.indent(type)
})
...
print.make('binary' ,function (ast) {
  print.binaryOp(ast.operator ,{first: ast.left ,second: ast.right})
})
...
print.make('seq' ,function (ast) {
  print.binaryOp(',' ,{first: ast.first ,second: ast.second ,noSpace2: true})
})
