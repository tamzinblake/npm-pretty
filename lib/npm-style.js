...
print.make = function (type ,fn) {
  print[type] = function (obj ,opts) {
    if (parens[type]) parens[type](obj ,opts ,fn)
  }
}
...
print.make('newline', function (str) {
  print.printedSomething = false
  print("\n")
})
...
print.make('emptyStatement', function () {
  print(';')
})
...
parens.functionExpression = function (ast ,opts ,cb) {
  var first = print.printedSomething
  if (first) print('(')
  cb(ast ,opts)
  if (first) print(')')
}
...
print.make('functionExpression', function (ast ,opts) {
  opts = defaults(opts)
  print('function ')
  if (ast.name) print.nameNode(ast.name)
  print(' ')
...
print.make('switchBlock', function (arr) {
  print('{\n')
